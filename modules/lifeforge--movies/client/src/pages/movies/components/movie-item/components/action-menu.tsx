...
import ModifyTicketModal from '../../modals/modify-ticket-modal'
import { useMovieItemContext } from '../contexts/movie-item-context'
import { useDeleteMovie } from '../hooks/use-delete-movie'
import { useToggleWatched } from '../hooks/use-toggle-watched'
import { useUpdateMovieData } from '../hooks/use-update-movie-data'
