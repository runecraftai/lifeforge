      ...
      updatePassword: {
        ...
        input: {
          body: {
            ...
            required: ['oldPassword', 'password', 'passwordConfirm'],
            additionalProperties: false
          }
        },
        output: {
    ...
    oauth: {
      ...
      providers: {
        ...
        listOptions: {
          method: 'get',
          description:
            'List all available OAuth provider options for configuration',
          noAuth: false,
          encrypted: true,
          isDownloadable: false,
          media: null,
      ...
      output: {
        OK: {
          ...
          items: {
            ...
            required: ['id', 'icon', 'moduleName', 'componentName'],
            additionalProperties: false
          }
        }
      }
